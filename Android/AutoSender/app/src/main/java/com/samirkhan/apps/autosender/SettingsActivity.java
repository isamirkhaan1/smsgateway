...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String currentURL = getSharedPreferences("com.samirkhan.apps.autosender.file", Context.MODE_PRIVATE).getString("url", null);
        if (currentURL != null)
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                *   Clear it and Toast User..   */
                ...
                SharedPreferences.Editor editor = getSharedPreferences("com.samirkhan.apps.autosender.file", Context.MODE_PRIVATE).edit();
