...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        query = "CREATE TABLE sms (id int PRIMARY KEY, contact TEXT, message TEXT, status int);";
        db.execSQL(query);
    }
    ...
    public void insert(String id, String contact, String message, String status) {

        SQLiteDatabase database = getWritableDatabase();

        //  design query and execute it..
        query = "insert into sms values(" + id + ", \'" + contact + "\', \'" + message + "\', " + status + ");";
